    ...
    for e in range(args.epochs):
        ...
        for batch_id, (x, _) in enumerate(train_loader):
            ...
            if (args.depth_loss): 
                ...
                total_loss = content_loss + style_loss + depth_loss 
            else:
...
def stylize(args):
    ...
    if args.model.endswith(".onnx"):
        ...
        with torch.no_grad():
            style_model = TransformerNet() # TransformerNet()
...
def main():
    ...
    train_arg_parser.add_argument("--depth-weight", type=float, default=1e10,
